...
class RegisterFCTResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'FCT Registrationcc';
    
    protected static ?string $modelLabel = 'FCT Registration1';
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('customer_by')
                    ->label('Customer')
                    ->searchable()
                    ->sortable(),
            ...
            ->actions([
                ...
                Tables\Actions\DeleteAction::make()
                    ->before(function ($record) {
                        // Hapus semua problem FCT yang terkait secara permanen
                        $record->problemFcts()->forceDelete();
                    })
                    ->action(function ($record) {
                        // Hapus register FCT secara permanen dari database
                        $record->forceDelete();
                    }),
            ])
            ->bulkActions([
    ...
    public static function getPages(): array
    {
        return [
            ...
            'edit' => Pages\EditRegisterFCT::route('/{record}/edit'),
             'view' => Pages\ViewRegisterFCT::route('/{record}/view'),
        ];
    }
}
